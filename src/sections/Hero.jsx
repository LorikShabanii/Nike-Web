...
const Hero = () => {
  ...
  return (
    ...
    >
      <div className=
      "relative xl:width-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28"
      >
        <p className=
        "text-xl font-montserrat text-coral-red"
        ...
        >
          ...
          <br />
          <span className=
          "text-coral-red inline-block mt-3"
          >Nike</span>  Shoes
        </h1>
        <p className=
      ...
      <div className="relative flex-1 flex justify-center items-center xl:min-h-screen min-xl:py-40 bg:primary bg-hero bg-cover bg-center">
        <img
          src={bigShoeImg}
          alt="shoe collection"
          width={610}
